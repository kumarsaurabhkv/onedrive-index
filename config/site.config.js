...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'wizardCoder@2mf7pl.onmicrosoft.com',
  ...
  protectedRoutes: ['/Private', '/TEST/😎Another Private Folder Password 123'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:bollywoodprobeats@hotmail.com',
